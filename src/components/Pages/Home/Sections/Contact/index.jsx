...
const ContactSection = ({email, github, linkedIn, linkedInDisp, phone, phoneDisp, smallMap, largeMap}) => {
  return (
    <section id="contact">
      <Container>
        <Grid container>
        ...
        <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
            <div className="contact-text">
              ...
              <br/>
              <a href={github} target="_blank"><i className="fab fa-github"></i>&nbsp; {github}</a>
              <br/>
